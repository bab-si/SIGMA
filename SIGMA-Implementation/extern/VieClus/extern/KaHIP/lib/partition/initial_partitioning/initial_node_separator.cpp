...
NodeWeight initial_node_separator::single_run( const KaHIP::PartitionConfig & config, KaHIP::graph_access & G) {
...
void initial_node_separator::compute_node_separator( const KaHIP::PartitionConfig & config, KaHIP::graph_access & G) {
