#ifndef RAND_PARTITIONER_HPP
#define RAND_PARTITIONER_HPP
...
class RandPartitioner : public EdgeListEPartitioner
{
  private:
  ...
  public:
    RandPartitioner(std::string basefilename, bool need_k_split);
    void split();
};
