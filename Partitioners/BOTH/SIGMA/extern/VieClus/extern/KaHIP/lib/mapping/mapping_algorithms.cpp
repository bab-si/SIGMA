...
#include "extern/KaHIP/lib/mapping/mapping_algorithms.h"
...
void mapping_algorithms::construct_a_mapping( KaHIP::PartitionConfig & config, KaHIP::graph_access & C, matrix & D, std::vector< NodeID > & perm_rank) {
...
void mapping_algorithms::graph_to_matrix( KaHIP::graph_access & C, matrix & C_bar) {
