...
class LabelPropagation
{
    public:
         ...
         */
        PartitionID performMultiLevelLabelPropagation(const KaHIP::PartitionConfig &config,
         ...
         */
        static NodeID performLabelPropagation(const KaHIP::PartitionConfig &config,
                                              KaHIP::graph_access *G);
    ...
    protected:
        ...
        /**
            ...
            \return Number of node moves, total count of all turns.
         */
        NodeID performLabelPropagation(const KaHIP::PartitionConfig &config);
