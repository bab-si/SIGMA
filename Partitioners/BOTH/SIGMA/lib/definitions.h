...
#else
// Changed From int edgeWeight to double edgeweight to allow for artificial weights. 
...
typedef enum {
	...
	ONEPASS_FRACTIONAL_GREEDY,
        ...
        ONEPASS_MC_AVG_FENNEL,           // Multi Constraint Graph Partitioning
        ONEPASS_MC_MAX_FENNEL,           // Multi Constraint Graph Partitioning
        ONEPASS_RANGE_FENNEL,            // Multi Constraint Graph Partitioning
        ONEPASS_HDRF,                    // Multi Constraint Graph Partitioning
        ONEPASS_EDGES_LINEAR,             // Multi Constraint Graph Partitioning
        ONEPASS_FENNEL_MULT_OBJ
