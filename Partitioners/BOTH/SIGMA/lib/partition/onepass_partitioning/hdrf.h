...
#ifndef ONEPASS_HDRF_7I4IR31Y
#define ONEPASS_HDRF_7I4IR31Y
...
class onepass_hdrf : public vertex_partitioning {
public:
  onepass_hdrf(PartitionID k0, PartitionID kf, PartitionID max_blocks,
                 NodeID n_threads, bool hashing = false, float gamma = 1.5);
  virtual ~onepass_hdrf();
...
#endif /* end of include guard: ONEPASS_HDRF_7I4IR31Y */
