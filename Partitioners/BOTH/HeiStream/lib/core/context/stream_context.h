...
struct StreamContext {
    ...
    StreamContext(Config& config_in, StreamMode mode_in,
                  std::chrono::steady_clock::time_point main_start_in)
        : config(config_in), mode(mode_in), main_start(main_start_in) {}
};
